...
## we use the median of all measurement for each patch.
...
## Subsetting the data ##################################################################################################
  ...
  post_ext_data_aggregate = aggregate(agg_formula_1, data = post_ext_data, FUN = median, na.action = na.omit)
  post_ext_landscape_data_aggregate = aggregate(agg_formula_1, data = post_ext_landscape_data, FUN = median, na.action = na.omit)
  ...
  # aggregating by tube id (taking the median of each time)
  ...
  fig_data_agregate = aggregate(agg_formula_2, data = fig_data, FUN = median, na.action = na.omit)
  ...
  fig_data_landscape_aggregate = aggregate(agg_formula_3, data = fig_data_landscape, FUN = median, na.action = na.omit)
...
## Beta-diversity full model #################################################################################################
  ...
  bestNormalize(beta_data$BetaDiv, loo = T)
