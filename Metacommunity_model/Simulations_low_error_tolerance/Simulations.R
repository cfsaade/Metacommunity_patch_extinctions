## Simulations_low_error_tolerance.R
##
## Execute the code below to reproduce 10% of the simulations with a more accurate (but slower) solver.
##
## !!!!!
## This code is written to run in parallel on 6 cores and takes a while to run. Please ensure that your computer has
## enough core or change the parameter mc.core (l. 207)
## !!!!
